function SWEP:GetShouldRaiseRight()
    ...
    if self:GetReloading() and (self:ShouldReloadBoth() or not self.AkimboSingleReload or not self:GetReloading2()) then return false end
...
function SWEP:GetShouldRaiseLeft()
    if self:GetHolstering() then return false end
    if self:GetReloading() and (self:ShouldReloadBoth() or not self.AkimboSingleReload or self:GetReloading2()) then return false end
